...
public class Hlevelthree extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        setContentView ( R.layout.activity_hlevelthree );
    ...
    public View.OnClickListener undooo(){
        final View.OnClickListener undooo = new View.OnClickListener () {
            @Override
            public void onClick( View v ) {
                Vibrator vibrator = (Vibrator) getSystemService ( Context.VIBRATOR_SERVICE );
                vibrator.vibrate ( 100 );
                ...
                if(butId == button1.getId ()){
                    ...
                    doubleUndo (button25,button16,button23,button24,button32,button34,button33,con9,con13,type1 );
                }
                    ...
                    doubleUndo (button27,button18,button24,button26,button33,button36,button35,con10,con14,type1);
                }
                    ...
                    doubleUndo (button29,button26,button20,button28,button35,button38,button37,con11,con15,type1 );
                }
                else if(butId == button30.getId ()){
                    singleUndo (button30,button28,button22,button31,con12,type2 );
                }
                else if(butId == button31.getId ()){
                    doubleUndo (button31,button28,button12,button30,button37,button40,button39,con12,con16,type1);
                }
                else if(butId == button32.getId ()){
                    singleUndo (button32,button25,button33,button34,con13,type2 );
                }
                else if(butId == button33.getId ()){
                    doubleUndo (button33,button32,button25,button34,button27,button35,button36,con13,con14,type2 );
                }
                else if(butId == button34.getId ()){
                    doubleUndo (button34,button32,button25,button33,button41,button43,button42,con13,con17,type1);
                }
                else if(butId == button35.getId ()){
                    doubleUndo (button35,button33,button27,button36,button29,button37,button38,con14,con15,type2);
                }
                else if(butId == button36.getId ()){
                    doubleUndo (button36,button33,button27,button35,button42,button45,button44,con14,con18,type1 );
                }
                else if(butId == button37.getId ()){
                    doubleUndo (button37,button29,button35,button38,button31,button39,button40,con15,con16,type2  );
                }
                else if(butId == button38.getId ()){
                    doubleUndo (button38,button35,button29,button37,button44,button47,button46,con15,con19,type1  );
                }
                else if(butId == button39.getId ()){
                    singleUndo ( button39,button31,button37,button40,con16,type2 );
                }
                else if(butId == button40.getId ()){
                    doubleUndo ( button40,button37,button31,button39,button46,button49,button48,con16,con20,type1 );
                }
                else if(butId == button41.getId ()){
                    singleUndo (button41,button34,button42,button43,con17,type2);
                }
                else if(butId == button42.getId ()){
                    doubleUndo (button42,button34,button41,button43,button36,button44,button45,con17,con18,type2 );
                }
                else if(butId == button43.getId ()){
                    singleUndo (button43,button34,button42,button41,con17,type1);
                }
                else if(butId == button44.getId ()){
                    doubleUndo (button44,button36,button42,button45,button38,button46,button47,con18,con19,type2);
                }
                else if(butId == button45.getId ()){
                    singleUndo (button45,button36,button42,button44,con18,type1 );
                }
                else if(butId == button46.getId ()){
                    doubleUndo (button46,button38,button44,button47,button49,button48,button40,con19,con20,type2  );
                }
                else if(butId == button47.getId ()){
                    singleUndo (button47,button44,button38,button46,con19,type1  );
                }
                else if(butId == button48.getId ()){
                    singleUndo ( button48,button49,button46,button40,con20,type2 );
                }
                else if(butId == button49.getId ()){
                    singleUndo ( button49,button46,button40,button48,con20,type1 );
                }
            }
