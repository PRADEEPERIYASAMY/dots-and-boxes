...
public class NoPlayers3 extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        setContentView ( R.layout.activity_no_players3 );
            ...
            public void onClick( View v ) {
                ...
                try {
                    ...
                    if(NoPlayers >=2 && NoPlayers <= 4){
                        Intent intent = new Intent ( getApplicationContext (),Hlevelthree.class );
