...
public class Hleveltwo extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        setContentView ( R.layout.activity_hleveltwo );
        ...
        View.OnClickListener undooo = new View.OnClickListener () {
            ...
            public void onClick( View v ) {
                ...
                if(butId == button1.getId ()){
                    ...
                    singleUndo (button34,button32,button25,button33,con13,type1);
                }
                    ...
                    singleUndo (button36,button33,button27,button35,con14,type1 );
                }
                    ...
                    singleUndo (button38,button35,button29,button37,con15,type1  );
                }
                else if(butId == button39.getId ()){
                    singleUndo ( button39,button31,button37,button40,con16,type2 );
                }
                else if(butId == button40.getId ()){
                    singleUndo ( button40,button37,button31,button39,con16,type1 );
                }
            }
        };
        count--;
