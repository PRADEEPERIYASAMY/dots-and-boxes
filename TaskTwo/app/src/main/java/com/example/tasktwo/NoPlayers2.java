...
public class NoPlayers2 extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        setContentView ( R.layout.activity_no_players2 );
            ...
            public void onClick( View v ) {
                ...
                try {
                    ...
                    if(NoPlayers >=2 && NoPlayers <= 4){
                        Intent intent = new Intent ( getApplicationContext (),Hleveltwo.class );
